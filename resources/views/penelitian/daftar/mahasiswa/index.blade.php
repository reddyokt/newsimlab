                ...
                <div class="col-lg-8 mx-auto">
                    ...
                    <nav class="d-inline-block" aria-label="breadcrumb">
                        <ol class="breadcrumb text-white">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Sign Up - Mahasiswa</li>
                        </ol>
                    </nav>
                    <!-- /nav -->
                </div>
                                    ...
                                    <form class="text-start mb-3">
                                        <div class="form-select-wrapper mb-4">
                                            <select class="form-select" aria-label="Default select example">
                                                ...
                                                <option value="S1A">S1 Kelas A</option>
                                                <option value="S1B">S1 Kelas B</option>
                                        ...
                                        <div class="form-floating mb-4">
                                            <input type="file" class="form-control" placeholder="Upload file JSA"
                                                id="filejsa">
                                            <label for="filejsa">Upload file JSA</label>
                                        </div>
                                        <div class="form-floating mb-4">
                                            <textarea id="judul" class="form-control" placeholder="Judul Penelitian" style="height: 120px" required></textarea>
