                ...
                <div class="col-lg-8 mx-auto">
                    ...
                    <nav class="d-inline-block" aria-label="breadcrumb">
                        <ol class="breadcrumb text-white">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Sign Up - Dosen</li>
                        </ol>
                    </nav>
                    <!-- /nav -->
                </div>
                            ...
                            <div class="col-lg-6">
                                <div class="p-10 p-md-11 p-lg-13">
                                    ...
                                    <form class="text-start mb-3">
                                        ...
                                        <div class="form-floating mb-4">
                                            <input type="number" class="form-control" placeholder="NIDN" id="nidn">
                                            <label for="loginName">NIDN</label>
                                        </div>
                                        <div class="form-floating mb-4">
