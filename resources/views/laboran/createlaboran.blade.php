    ...
    <div class="row">
        ...
        <div class="col-lg-12">
            <div id="addproduct-accordion" class="custom-accordion">
                ...
                <div class="card">
                    <form action="/laboran/create" method="POST" enctype="multipart/form-data">
                        @csrf
                            ...
                            <div class="p-4">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1 overflow-hidden">
                                        <h5 class="font-size-16 mb-1">Laboran Information</h5>
                        ...
                        <div id="addproduct-billinginfo-collapse" class="collapse show"
                            ...
                            <div class="p-4 border-top">
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            <label class="form-label" for="name">Nama Laboran</label>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            ...
                                            <input id="nip" name="nip" type="text" class="form-control"
                                                placeholder="Enter your NIP" required minlength="5" maxlength="10">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            ...
                                            <input id="phone" name="phone" type="number" class="form-control"
                                                minlength="10" maxlength="14" placeholder="Enter your phone" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="mb-3 row">
