        ...
        <div class="d-flex">
            ...
            <div class="dropdown d-inline-block">
                ...
                <div class="dropdown-menu dropdown-menu-end">
                    ...
                    <a class="dropdown-item" data-bs-toggle="modal" data-bs-target=".bs-example-modal-center"><i class="uil uil-lock-alt font-size-18 align-middle me-1 text-muted"></i> <span class="align-middle">Change Password</span></a>
                    {{-- <button type="button" class="btn btn-primary waves-effect waves-light" >Center Modal</button> --}}
