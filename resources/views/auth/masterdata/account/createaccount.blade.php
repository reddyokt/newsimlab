                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input id="image" name="image" type="file" class="form-control" accept="image/png, image/jpeg, application/pdf"placeholder="#">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label class="form-label" class="control-label">Pilih Role</label>
                                            <select class="select2 form-control select2-multiple" name="role" id="role">
                                        ...
                                        <div id="divpda" style="display: none">
                                            ...
                                            <label class="form-label"  class="control-label">Pilih PDA</label>
                                                <select class="form-select form-select-solid" name="pda" id="pda" data-control="select2" data-placeholder="{{__('account.placeholder_pda')}}">
                                                </select>
                                            </div>
                                        </div>
                                    </div>
