...
@section('content')
    @component('common-components.breadcrumb')
        @slot('pagetitle') File Type @endslot
        @slot('title') File Type List @endslot
    @endcomponent
                                    ...
                                    <td>
                                        <ul class="list-inline mb-0">
                                            <li class="list-inline-item">
                                                <a href="/filetype/edit/{{$file->id_filetype}}" class="px-2 text-primary"><i
                                                        class="uil uil-pen font-size-18"></i></a>
                                            </li>
                                            <li class="list-inline-item">
                                                <a href="/filetype/delete/{{$file->id_filetype}}" class="px-2 text-danger"><i
