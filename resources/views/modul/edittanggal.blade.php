                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control datepicker" placeholder="dd M, yyyy"
                                            ...
                                            data-provide="datepicker" value="{{ \Carbon\Carbon::parse($x->tanggal_praktek)->locale('id')->format('j F Y') }}" min="{{ \Carbon\Carbon::parse($x->tanggal_praktek)->locale('id')->format('j F Y') }}" name="tanggal">
