                            ...
                            <div class="p-4">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1 overflow-hidden">
                                        <h5 class="font-size-16 mb-1">Dosen Information</h5>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            ...
                                            <input id="nidn" name="nidn" type="number" class="form-control" minlength="10" maxlength="10"
                                                placeholder="Enter your NIDN" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
