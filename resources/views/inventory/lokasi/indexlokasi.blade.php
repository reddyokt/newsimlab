...
@section('content')
                ...
                <div class="card-body">
                    <div>
                        <a href="#" data-bs-toggle="modal" data-bs-target=".addLokasi"
                            ...
                            <i class="uil-building text-primary"></i> Add Lokasi</a>
                        <a href="#" data-bs-toggle="modal" data-bs-target=".addLemari" class="text-success">
                            <i class="uil-grid text-success"></i> Add Lokasi</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="modal fade addLokasi" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel"
                aria-hidden="true">
            ...
            <!-- Center Modal example -->
            <div class="modal fade addLemari" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel"
                aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                                        ...
                                        <div class="col-lg-12">
                                            ...
                                            <div class="col-lg-12">
                                                <select class="form-control" name="id_lokasi">
                                                    <option selected disabled>Pilih Lokasi</option>
                                                    @foreach ($lokasis as $lokasi => $value)
                                                        <option value="{{ $value->id_lokasi }}">{{ $value->nama_lokasi }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                            </div>
