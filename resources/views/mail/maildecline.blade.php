                        ...
                        <td align="center" valign="center" style="{{$style['td']}}">
                            ...
                            <div style="{{$style['email-content']}}">
                                ...
                                <div style="{{$style['div-text']}}">
                                    ...
                                    <p style="{{$style['p-text']}}">Dinyatakan tidak <strong>valid</strong>. Data pengajuan anda ditolak karena <b>{{$reject_notes}}</b> </p>
                                    <p style="{{$style['p-text']}}">
                                        Silahkan ajukan ulang, dan perhatikan alasan penolakan. Perbaiki usulan agar dapat diterima
                                    </p><br><br>
                                    <p style="{{$style['p-text']}}">
                                        Terima kasih
                                    </p>
