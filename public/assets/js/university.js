$(function () {
    ...
    if($('.tableServerSide').length != 0){
        ...
        $(".btnclear").click(function(){
            ...
            $(".filterPTMA").val("");
            $(".filterPTMA").prop("checked", false);
        });

        $(".filterPTMA").change(function(){
            if ($(this).is(':checked')) {
                $(".filterPTMA").val("Y");
            } else {
                $(".filterPTMA").val("N");
                        ...
                        success: function(data) {
                            if (data.status) {
                                Swal.fire({
                                    ...
                                    window.location.replace("/university/index");
                                });
                            } else {
                                Swal.fire({
