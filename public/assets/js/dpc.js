$(function () {
    ...
    $("#dpd").change(function(){
        ...
        $.ajax({
            ...
            type: 'GET',
            url: '/masterdpc/regency/'+value,
            success: function(data) {
                $.each(data, function(index, option) {
                    $('#regencies').append($('<option>').val(option.regency_id).text(option.name));
                });
            }
        });
    })
    ...
    $("#regencies").change(function(){
        var value = $("#regencies option:selected").text();
        $("#name").val(value)
    })

    $(document).on("submit", "#form_add", function(e) {
        var url = "/masterdpc/store";
                        ...
                        success: function(data) {
                            if (data.status) {
                                Swal.fire({
                                    ...
                                    window.location.replace("/masterdpc/index");
                                });
                            } else {
                                Swal.fire({
